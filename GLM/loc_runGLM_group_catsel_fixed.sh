...
subs_to_fix="01 04 18 20"
all_subs="01 04 05 07 08 09 11 13 15 16 18 19 20 22 25 26 29 30 31 32 33 34 35 37 38"
good_subs="05 07 08 09 11 13 15 16 19 22 25 26 29 30 31 32 33 34 35 37 38"
anal_dir="" # PATH TO MAIN DATA DIRECTORY
scripts_dir= # PATH TO SCRIPTS DIRECTORY
scripts_dir=$scripts_dir/GLM
group_glm_script=loc_group_catsel # name of group GLM script from Step 2
main_glm_name=loc_catsel # prefix of analysis directory
zclusts="1 2 3 4 5 6 7 8" # which t-test z statistics to fix, this depends on design
...
for sub in $subs_to_fix; do
    ...
    fslmaths $nomissing_glm_dir/mask -add $sub_dir/inv_mask_loc -thr 2 -bin $main_glm_dir/missing_${sub}
done
proc_subs=""
for sub in $subs_to_fix; do
...
for filename in z*stat*.nii.gz; do
